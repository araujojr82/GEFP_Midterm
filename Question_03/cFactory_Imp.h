#ifndef _cFactory_Imp_HG_
#define _cFactory_Imp_HG_
...
class cFactory_Imp : public iMediator
{
public:
    ...
    virtual std::vector<std::string> Mediate( iGameObject* theActiveGO, std::string targetObj, std::vector<std::string> parameters);
